...
if (!class_exists('Grid_Plus')) {
    class Grid_Plus
    {
        ...
        function grid_plus_admin_enqueue_script()
        {
            ...
            if (isset($screen->base)) {
                ...
                if ($screen->base === 'grid-plus_page_grid_plus_setting') {
                    ...
                    wp_enqueue_script('grid-plus-stack', G5PLUS_GRID_URL . 'assets/lib/grid-stack/gridstack' . $min . '.js', array('underscore'), true);
        ...
        function grid_plus_shortcode_register_script()
        {
            ...
            wp_register_script('grid-plus-stack', G5PLUS_GRID_URL . 'assets/lib/grid-stack/gridstack' . $min . '.js', array('underscore'), true);
